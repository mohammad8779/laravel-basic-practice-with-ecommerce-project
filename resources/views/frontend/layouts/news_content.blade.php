    ...
    <div class="content">
        <div class="image group">
            <div class="grid images_3_of_1">
                <img src="{{asset('public/frontend/')}}/images/newsimg1.jpg" alt="" />
            </div>
        ...
        <div class="image group">
            <div class="grid images_3_of_1">
                <img src="{{asset('public/frontend/')}}/images/newsimg2.jpg" alt="" />
            </div>
            <div class="grid news_desc">
                <h3>Lorem Ipsum is simply dummy text </h3>
        ...
        <div class="image group">
            <div class="grid images_3_of_1">
                <img src="{{asset('public/frontend/')}}/images/newsimg3.jpg" alt="" />
            </div>
            <div class="grid news_desc">
                <h3>Lorem Ipsum is simply dummy text </h3>
